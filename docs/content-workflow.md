...
3. Keep public additions short, specific, and useful without mirroring the raw notes.
...
Keep rough stream notes and stream ideas in the Google Doc. Add repo-backed
notes later only if there is a clear need for curated, permalinked writing.
